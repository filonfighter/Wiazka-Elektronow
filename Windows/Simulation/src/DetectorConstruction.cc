...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    G4Box* worldBox = new G4Box("World", 2.0*m, 2.0*m, 2.0*m);
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0, 0, 0.25*m), fWaterPhantomLogical, "WaterPhantom", worldLogical, false, 0);
